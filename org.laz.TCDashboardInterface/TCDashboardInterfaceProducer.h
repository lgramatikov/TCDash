...
extern PCSTR c_TCDashboardInterfaceIntrospectionXml;

ref class TCDashboardInterfaceProducer;

public interface class ITCDashboardInterfaceProducer
{
    event Windows::Foundation::TypedEventHandler<TCDashboardInterfaceProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    event Windows::Foundation::TypedEventHandler<TCDashboardInterfaceProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<TCDashboardInterfaceProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<TCDashboardInterfaceProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
};

public ref class TCDashboardInterfaceProducer sealed : [Windows::Foundation::Metadata::Default] ITCDashboardInterfaceProducer
{
public:
    TCDashboardInterfaceProducer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~TCDashboardInterfaceProducer();

    // The implementation of ITCDashboardInterfaceService that will handle method calls and property requests.
    property ITCDashboardInterfaceService^ Service
    {
        ITCDashboardInterfaceService^ get() { return m_serviceInterface; }
        void set(ITCDashboardInterfaceService^ value) { m_serviceInterface = value; }
    }

    // Used to send signals or register functions to handle received signals.
    property TCDashboardInterfaceSignals^ Signals
    {
        TCDashboardInterfaceSignals^ get() { return m_signals; }
    }
    
    // This event will fire whenever this producer is stopped.
    virtual event Windows::Foundation::TypedEventHandler<TCDashboardInterfaceProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    
    // This event will fire whenever the producer loses the session that it created.
    virtual event Windows::Foundation::TypedEventHandler<TCDashboardInterfaceProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    
    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<TCDashboardInterfaceProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<TCDashboardInterfaceProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
...
private:
    static void CallGoFunkyHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    static void CallGoBoringHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    ...
    TCDashboardInterfaceSignals^ m_signals;
    ITCDashboardInterfaceService^ m_serviceInterface;
