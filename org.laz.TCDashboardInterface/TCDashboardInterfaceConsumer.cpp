...
std::map<alljoyn_interfacedescription, WeakReference*> TCDashboardInterfaceConsumer::SourceInterfaces;

TCDashboardInterfaceConsumer::TCDashboardInterfaceConsumer(AllJoynBusAttachment^ busAttachment)
...
TCDashboardInterfaceConsumer::~TCDashboardInterfaceConsumer()
{
...
void TCDashboardInterfaceConsumer::OnSessionLost(_In_ alljoyn_sessionid sessionId, _In_ alljoyn_sessionlostreason reason)
{
...
void TCDashboardInterfaceConsumer::OnSessionMemberAdded(_In_ alljoyn_sessionid sessionId, _In_ PCSTR uniqueName)
{
    if (sessionId == m_sessionId)
    {
...
void TCDashboardInterfaceConsumer::OnSessionMemberRemoved(_In_ alljoyn_sessionid sessionId, _In_ PCSTR uniqueName)
{
    if (sessionId == m_sessionId)
    {
...
QStatus TCDashboardInterfaceConsumer::AddSignalHandler(_In_ alljoyn_busattachment busAttachment, _In_ alljoyn_interfacedescription interfaceDescription, _In_ PCSTR methodName, _In_ alljoyn_messagereceiver_signalhandler_ptr handler)
{
...
IAsyncOperation<TCDashboardInterfaceJoinSessionResult^>^ TCDashboardInterfaceConsumer::JoinSessionAsync(
    _In_ AllJoynServiceInfo^ serviceInfo, _Inout_ TCDashboardInterfaceWatcher^ watcher)
{
    return create_async([serviceInfo, watcher]() -> TCDashboardInterfaceJoinSessionResult^
    {
        auto result = ref new TCDashboardInterfaceJoinSessionResult();
        result->Status = AllJoynStatus::Ok;
        result->Consumer = nullptr;

        result->Consumer = ref new TCDashboardInterfaceConsumer(watcher->BusAttachment);
...
IAsyncOperation<TCDashboardInterfaceGoFunkyResult^>^ TCDashboardInterfaceConsumer::GoFunkyAsync()
{
    return create_async([this]() -> TCDashboardInterfaceGoFunkyResult^
    {
...
IAsyncOperation<TCDashboardInterfaceGoBoringResult^>^ TCDashboardInterfaceConsumer::GoBoringAsync()
{
    return create_async([this]() -> TCDashboardInterfaceGoBoringResult^
    {
...
void TCDashboardInterfaceConsumer::OnPropertyChanged(_In_ alljoyn_proxybusobject obj, _In_ PCSTR interfaceName, _In_ const alljoyn_msgarg changed, _In_ const alljoyn_msgarg invalidated)
{
...
int32 TCDashboardInterfaceConsumer::JoinSession(_In_ AllJoynServiceInfo^ serviceInfo)
{
    alljoyn_sessionlistener_callbacks callbacks =
    {
        AllJoynHelpers::SessionLostHandler<TCDashboardInterfaceConsumer>,
        AllJoynHelpers::SessionMemberAddedHandler<TCDashboardInterfaceConsumer>,
        AllJoynHelpers::SessionMemberRemovedHandler<TCDashboardInterfaceConsumer>
    };
    ...
    alljoyn_interfacedescription description = alljoyn_busattachment_getinterface(m_nativeBusAttachment, "org.laz.TCDashboardInterface");
