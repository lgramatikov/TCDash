...
public interface class ITCDashboardInterfaceConsumer
{
    event Windows::Foundation::TypedEventHandler<TCDashboardInterfaceConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<TCDashboardInterfaceConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<TCDashboardInterfaceConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
};

public ref class TCDashboardInterfaceConsumer sealed  : [Windows::Foundation::Metadata::Default] ITCDashboardInterfaceConsumer
{
public:
    TCDashboardInterfaceConsumer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~TCDashboardInterfaceConsumer();
    ...
    static Windows::Foundation::IAsyncOperation<TCDashboardInterfaceJoinSessionResult^>^ JoinSessionAsync(_In_ Windows::Devices::AllJoyn::AllJoynServiceInfo^ serviceInfo, _Inout_ TCDashboardInterfaceWatcher^ watcher);

    // Call the GoFunky method
    Windows::Foundation::IAsyncOperation<TCDashboardInterfaceGoFunkyResult^>^ GoFunkyAsync();
    // Call the GoBoring method
    Windows::Foundation::IAsyncOperation<TCDashboardInterfaceGoBoringResult^>^ GoBoringAsync();
    ...
    virtual event Windows::Foundation::TypedEventHandler<TCDashboardInterfaceConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;

    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<TCDashboardInterfaceConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<TCDashboardInterfaceConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
