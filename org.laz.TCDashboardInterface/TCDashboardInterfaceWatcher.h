...
ref class TCDashboardInterfaceWatcher;

public interface class ITCDashboardInterfaceWatcher
{
    event Windows::Foundation::TypedEventHandler<TCDashboardInterfaceWatcher^, Windows::Devices::AllJoyn::AllJoynServiceInfo^>^ Added;
    event Windows::Foundation::TypedEventHandler<TCDashboardInterfaceWatcher^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
};

public ref class TCDashboardInterfaceWatcher sealed : [Windows::Foundation::Metadata::Default] ITCDashboardInterfaceWatcher
{
public:
    TCDashboardInterfaceWatcher(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~TCDashboardInterfaceWatcher();

    // This event will fire whenever a producer for this service is found.
    virtual event Windows::Foundation::TypedEventHandler<TCDashboardInterfaceWatcher^, Windows::Devices::AllJoyn::AllJoynServiceInfo^>^ Added;

    // This event will fire whenever the watcher is stopped.
    virtual event Windows::Foundation::TypedEventHandler<TCDashboardInterfaceWatcher^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
